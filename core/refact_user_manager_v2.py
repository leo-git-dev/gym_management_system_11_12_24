...
class UserManagementApp(ttk.Frame):
    ...
    def create_training_staff_menu(self):
        ...
        # No Payment Type field for Staff
        # Schedule Table
    ...
    def create_wellbeing_staff_menu(self):
        ...
        ttk.Label(frame, text="Add Wellbeing Staff", font=("Helvetica", 14)).grid(row=0, column=0, columnspan=2,
                                                                                  pady=10)
    ...
    def add_user_with_schedule(self, name_entry, gym_dropdown, extra_field, schedules, user_type):
        # Revised to remove payment_type requirement for staff
        try:
            name = name_entry.get()
            gym = gym_dropdown.get()
