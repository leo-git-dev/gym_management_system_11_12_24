...
class UserManagementApp(ttk.Frame):
    ...
    def add_management_staff(self, name, gym, role, payment_type):
        try:
            ...
            cost = MemberManagement.calculate_membership_cost("Premium")  # Assuming Management Staff have Premium membership
            MemberManagement.add_member(
                name=name,
                user_type="Management Staff",
                gym_id=gym_data["gym_id"],
                role=role,
                cost=2500,  # As per member_management.py defaults
                join_date="N/A",  # Default or can be modified as needed
                city=city,
                payment_type=payment_type
            )
    ...
    def search_user_by_name(self, user_type, name, result_frame):
        try:
            ...
            details = [
                ...
                ("Loyalty Points", user.get("loyalty_points", 0)),  # Added Loyalty Points
                ("Schedule", schedule),
            ]
    ...
    def create_view_all_users_menu(self):
        ...
        # Updated Treeview to include 'Loyalty Points'
        users_tree = ttk.Treeview(
            frame, columns=("ID", "Name", "User Type", "Gym", "Cost", "Payment Type", "Loyalty Points"), show="headings", height=15
        )
        ...
        users_tree.heading("Loyalty Points", text="Loyalty Points")  # Added Heading
        users_tree.column("Loyalty Points", width=120, anchor="center")  # Optional: Set column width and alignment
            ...
            for member in members:
                tree.insert(
                    ...
                    values=(
                        ...
                        member.get("loyalty_points", 0),  # Added Loyalty Points
                    ),
                )
        except Exception as e:
